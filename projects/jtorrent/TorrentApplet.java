...
public class TorrentApplet extends javax.swing.JApplet {

  /**
   * Initializes the applet TorrentApplet
   */
  @Override
  public void init() {
    ...
    JF.loadCerts(getClass().getResourceAsStream("javaforce.crt")
      , getClass().getResourceAsStream("jtorrent.crt"), "jftorrent.sourceforge.net");
  }
