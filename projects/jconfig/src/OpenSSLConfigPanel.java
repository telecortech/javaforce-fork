...
public class OpenSSLConfigPanel extends javax.swing.JPanel {

  /**
   * Creates new form OpenSSLConfigPanel
   */
  public OpenSSLConfigPanel() {
    initComponents();
    content.add(new OpenSSLPanel(null, null));
  }
