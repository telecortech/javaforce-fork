...
public abstract class Site extends javax.swing.JPanel implements FTP.ProgressListener {
  ...
  private void initComponents() {
    ...
    layout.setHorizontalGroup(
      ...
      .addComponent(split_main, javax.swing.GroupLayout.DEFAULT_SIZE, 660, Short.MAX_VALUE)
    );
  ...
  private TableCellEditor tableCellEditor = new DefaultCellEditor(new JTextField("")) {
    ...
    public Component getTableCellEditorComponent(JTable table,
                                      ...
                                      int column) {
      String str = "";
      if (value instanceof JLabel) str = ((JLabel)value).getText();
  ...
  private static class LocalFileSorter implements Comparable {
    ...
    public int compareTo(Object o) {
      ...
      //place folders first
      if (that.file.isDirectory() && !file.isDirectory()) return 1;
      if (!that.file.isDirectory() && file.isDirectory()) return -1;
  ...
  private static class RemoteFileSorter implements Comparable {
    ...
    public int compareTo(Object o) {
      ...
      //place folders first
      if (that.isDirectory() && !isDirectory()) return 1;
      if (!that.isDirectory() && isDirectory()) return -1;
  ...
  public void init(String initLocalDir) {
    if (initLocalDir.length() > 0) localDir.setText(initLocalDir.replaceAll("\\\\", "/"));
    TableColumn tc;
    ...
    if (JF.isWindows()) parseLocalRootWindows();
    parseLocal();
...
//          JFLog.log("link:" + fs[8] + " -> " + fs[9]);
    ...
    for(int a=0;a<sortedFiles.length;a++) {
      if (sortedFiles[a] == null) continue;
      ...
      if (fs[0].length() != 10) continue;
      if (fs[8].equals(".")) continue;
      if (fs[8].equals("..") && wd.equals("/")) continue;
  ...
  private void dblclickLocalTree() {
    ...
    do {
      if (tag.getName().equals("/")) break;  //top node
