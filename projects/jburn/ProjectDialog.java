...
public class ProjectDialog extends javax.swing.JDialog {
  ...
  public ProjectDialog(java.awt.Frame parent, boolean modal, Type type, String loadFilename) {
    ...
    if (loadFilename != null) {
      ...
      xmlFiles = xml.getTag(new String[] {"jburn", "files"});
      xmlOptions = xml.getTag(new String[] {"jburn", "options"});
      XML.XMLTag typeTag = xml.getTag(new String[] {"jburn", "options", "type"});
      XML.XMLTag nameTag = xml.getTag(new String[] {"jburn", "options", "name"});
  ...
  private void burnDataDisc() {
    File tmpImage;
    try {
      tmpImage = File.createTempFile("jburn-image", ".iso");
  ...
  private boolean saveImage(String filename, boolean auto) {
    ...
    try {
      File tmpFile = File.createTempFile("jburn-list-i", ".lst");
      ...
      int bootType;
      String bootFile;
      tag = xml.getTag(new String[] {"jburn", "options", "boot"});
      if (tag != null) {
        if (tag.content.equals("true")) {
          tag = xml.getTag(new String[] {"jburn", "options", "bootType"});
          if (tag != null) {
            bootType = JF.atoi(tag.content);
            if ((bootType >= 0) && (bootType <= 3)) {
              tag = xml.getTag(new String[] {"jburn", "options", "bootFile"});
              if (tag != null) {
