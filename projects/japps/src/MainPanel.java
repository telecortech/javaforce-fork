...
public class MainPanel extends javax.swing.JPanel {
  ...
  private String data[][][] = {
    //Web
    {
      {"Chromium", "Google Chromium Web Browser (no plugins)", "chromium", null},
      {"Chrome", "Google Chrome Web Browser (plugins:flash,pdf) (download)", "#web#chrome", "google-chrome-stable"},
      ...
      {"Java Web Plugin", "Java Applet support", "icedtea-6-plugin", "icedtea-web"},
    },
    //Office
    {
      ...
      {"Adobe PDF Reader", "View PDF documents (32bit only) (download)", "#web#pdf", "#web#pdf"},
    },
    //Graphics
    {
    ...
    //System
    {
      ...
      {"Wine", "Run MS-Windows apps (1990's technology)", "wine", "wine"},
      {"DosBox", "Run MS-DOS apps (1980's technology)", "dosbox", "dosbox"},
    },
    //Development
    {
