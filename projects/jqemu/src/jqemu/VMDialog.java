...
public class VMDialog extends javax.swing.JDialog {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(hdd, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("Drives", jPanel4);
  ...
  private void nameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nameKeyReleased
    if (vm != null) return;
    folder.setText(JF.getUserPath() + "/jqemu/" + name.getText().replaceAll(" ", ""));
  ...
  private boolean valid() {
    ...
    File newFile = new File(folder.getText() + "/jqemu.xml");
  ...
  private void newImage(JTextField hd, char idx) {
    ...
    String cmd[] = {"/usr/bin/qemu-img", "create", "-f", dialog.getImageType()
