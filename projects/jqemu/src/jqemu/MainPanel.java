...
public class MainPanel extends javax.swing.JPanel {
  ...
  public MainPanel(JFrame frame) {
    initComponents();
    JFLog.init(JF.getUserPath() + "/.jqemu.log", true);
    this.frame = frame;
    jbusClient = new JBusClient("org.jflinux.jqemu.Client" + Math.abs(new Random().nextInt()), new JBusMethods());
    jbusClient.start();
    listVMs();
  }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(connectVMservice, javax.swing.GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE)
                    .addComponent(nicConfig, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
  ...
  private void startVMserviceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startVMserviceActionPerformed
    ...
    if (idx == -1) return;
    VM vm = vms.get(idx);
    String vmXML = vm.folder + "/jqemu.xml";
  ...
  private void newVM() {
    ...
    try {
      ...
      vmPath.mkdirs();
      File vmXML = new File(vm.folder + "/jqemu.xml");
  ...
  private void addVMasService(String xml) {
    try {
      jbusClient.call("org.jflinux.service.jqemu", "addVM", "\"" + xml + "\"");
    } catch (Exception e) {
      JFLog.log(e);
    }
  }
  ...
  private void removeVMasService(String xml) {
    try {
      jbusClient.call("org.jflinux.service.jqemu", "removeVM", "\"" + xml + "\"");
    } catch (Exception e) {
      JFLog.log(e);
    }
  }
  ...
  private void startVMasService(String xml) {
    try {
      jbusClient.call("org.jflinux.service.jqemu", "startVM", "\"" + xml + "\"");
    } catch (Exception e) {
      JFLog.log(e);
    }
  }
