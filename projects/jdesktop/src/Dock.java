...
public class Dock extends javax.swing.JWindow implements ActionListener, MouseListener, MouseMotionListener, LayoutManager, X11Listener, monitordir.Listener {
  ...
  public Dock() {
    try {
      initComponents();
      IconCache.setPrefix("jdesktop-");
      arrowImage = IconCache.loadIcon("jdesktop-arrow");
      loadNetworkIcons();
      dock = this;
  ...
  private void HelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HelpActionPerformed
    try {
      Runtime.getRuntime().exec(new String[] {"jhelp", "jdesktop"});
    } catch (Exception e) {
      JFLog.log(e);
    }
  ...
  private String configFile = ".jdesktop.xml";
...
//    b.setToolTipText(name);  //mouse over the tooltip causes dock to hide
  ...
  private void addTrash() {
    trashEmptyImage = IconCache.scaleIcon(IconCache.loadIcon("jdesktop-trash-empty"), bx, by);
    trashFullImage = IconCache.scaleIcon(IconCache.loadIcon("jdesktop-trash-full"), bx, by);
    trash = addButton((isTrashFull() ? "jdesktop-trash-full" : "jdesktop-trash-empty"), "Trash", "#trash", getLastIdx(), true);
  ...
  private void addQuadControls() {
    ...
    networkQuad = addButton("jdesktop-network", "Network", "#network", 0, true);
  ...
  private void addHalfControls() {
    ...
    networkHalf = addButton("jdesktop-network", "Network", "#network", 0, true);
    soundHalf = addButton("jdesktop-sound", "Sound", "#sound", 0, true);
  ...
  private void checkBattery() {
    ...
    batteryImage = IconCache.loadIcon("jdesktop-battery");
    try {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        ...
        if (lns[0].indexOf("Discharging") == -1) {
          if (plugImage == null) {
            plugImage = IconCache.loadIcon("jdesktop-plug");
          }
