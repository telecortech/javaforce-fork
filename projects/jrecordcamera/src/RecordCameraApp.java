...
public class RecordCameraApp extends javax.swing.JFrame {
   ...
   */
  public RecordCameraApp() {
    initComponents();
    this.setContentPane(new MainPanel());
    pack();
    setPosition();
    JFImage icon = new JFImage();
    icon.loadPNG(this.getClass().getClassLoader().getResourceAsStream("jrecordcamera.png"));
    setIconImage(icon.getImage());
    setTitle("jfRecord Camera/" + MainPanel.version);
  }
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new RecordCameraApp().setVisible(true);
      }
    });
  }
