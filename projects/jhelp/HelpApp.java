...
//    System.out.println("Contents");
    try {
      ...
      sb.append("<html><body>");
      sb.append("<a href='file:///usr/share/jhelp/index.html'>Home</a> - Contents<br><br><br>");
      File files[] = new File("/usr/share/jhelp").listFiles();
...
//    System.out.println("Home");
    try {
      clear();
      html.setPage("file:///usr/share/jhelp/index.html");
    } catch(Exception e) {
      e.printStackTrace();
    }
...
//        System.out.println("url="+evt.getURL().toExternalForm());
        ...
        if (url.equals("file:/usr/share/jhelp/contents.html")) {
  ...
  private void gotoURL(String page) {
    try {
      clear();
      html.setPage("file:///usr/share/jhelp/" + page + ".html");
    } catch(Exception e) {
      e.printStackTrace();
    }
  }
