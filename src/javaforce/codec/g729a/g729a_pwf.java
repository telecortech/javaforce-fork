...
final class g729a_pwf implements g729a_constants {
  ...
  static void g729a_pwf(float[] fs, int i, float[] fs_0_, int i_1_,
    ...
    g729a_sinthesis_filter var_g729a_sinthesis_filter = var_g729a_encode_filters.sinthesis;
    g729a_sinthesis_filter var_g729a_sinthesis_filter_4_ = var_g729a_encode_filters.weghted;
    ...
    for (int i_24_ = 0; i_24_ < 40; i_24_++) {
      ...
      float f_26_ = (f_25_ - f_13_ * f_23_ - f_12_ * f_22_ - f_11_ * f_21_
