...
final class g729a_pst implements g729a_constants {
  ...
  static void g729a_pst(g729a_decode_speech var_g729a_decode_speech,
          ...
          float[] fs, int i) {
    g729a_sinthesis_filter var_g729a_sinthesis_filter = var_g729a_decode_filters.residual;
    g729a_sinthesis_filter var_g729a_sinthesis_filter_0_ = var_g729a_decode_filters.shortterm;
    g729a_tilt_filter var_g729a_tilt_filter = var_g729a_decode_filters.tilt;
    ...
    g729a_sinthesis_filter var_g729a_sinthesis_filter_8_ = new g729a_sinthesis_filter();
    if (i > 140) {
      i = 140;
    }
    fs_4_[0] = 1.0F;
    ...
    for (int i_11_ = i - 2; i_11_ < i + 4; i_11_++) {
      float f_12_ = g729a_common.g729a_correl(fs_3_, 144, fs_3_, 144 - i_11_);
      if (f_12_ > f_10_) {
        f_10_ = f_12_;
        i_9_ = i_11_;
      }
